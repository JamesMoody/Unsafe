...
#Region " api - cookies (int) "

    Public Shared Function cookies(ByVal index As Integer) As UnsafeValue
        Return New UnsafeValue(HttpContext.Current.Request.Cookies(index))
    End Function

#End Region
#Region " api - cookies (string) "

    Public Shared Function cookies(ByVal key As String) As UnsafeValue
        Return New UnsafeValue(HttpContext.Current.Request.Cookies(key))
    End Function
